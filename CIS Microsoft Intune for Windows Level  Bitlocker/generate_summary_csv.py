"""
Generate a summary CSV for CIS Intune for Windows BitLocker policies.
Reads from:
  - CIS Microsoft Intune for Windows Level  Bitlocker (root .json files only)
...
def smb_justification(name: str, recommended: str, complexity: str) -> str:
    ...
    name_words = name_lower.replace("cisv4 - win - bl - ", "").strip()
...
output_filename = "CIS_LBL_Policy_Summary_SAMPLE.csv" if SAMPLE_MODE else "CIS_LBL_Policy_Summary_FULL.csv"
